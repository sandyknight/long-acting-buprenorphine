calculate_count <- function(i, sir_data, main_data, start_dates, end_dates, yrs) {
  ...
  dt <- data.table::merge.data.table(
    main_data[, .(client_random_id, n_jy, disd, disrsn)],
    dt_inter
  )
...
calculate_counts <- function(sir_data, main_data, end_date) {
